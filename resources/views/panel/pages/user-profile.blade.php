                        ...
                        <div class="row gutters">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="profile-tile">
                                    ...
                                    <h6>Name - <span>Icha Putri</span></h6>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="profile-tile">
                                    ...
                                    <h6>Location - <span>Ujung Berung</span></h6>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="profile-tile">
                                    ...
                                    <h6>Phone - <span>+62 81234567891</span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="customScroll250">
                                <div class="timeline-activity">
                                    <div class="activity-log">
                                        <p class="log-name">Rosidah<small class="log-time">- 9 mins ago</small></p>
                                        <div class="log-details">University dashboard has been created<span class="text-success ml-1"> #New</span></div>
                                    </div>
                                    <div class="activity-log">
                                        <p class="log-name">Bu Tarno<small class="log-time">- 4 hrs ago</small></p>
                                    ...
                                    <div class="activity-log">
                                        <p class="log-name">Sukijah<small class="log-time">- 7 hrs ago</small></p>
                                        <div class="log-details">Developed 30 multipurpose Bootstrap 4 Admin Templates</div>
                                    </div>
                                    <div class="activity-log">
                                        <p class="log-name">Sukiman<small class="log-time">- 9 hrs ago</small></p>
                                        <div class="log-details">Best Design Award</div>
                                    </div>
                                    <div class="activity-log">
                                        <p class="log-name">Sudirjo<small class="log-time">- 4 hrs ago</small></p>
                                        <div class="log-details">
                                            Farewell day photos uploaded.
                                            <div class="stacked-images mt-1">
                                    ...
                                    <div class="activity-log">
                                        <p class="log-name">Sumanto<small class="log-time">- 3 hrs ago</small></p>
                                        <div class="log-details">Developed 30 multipurpose Bootstrap 4 Admin Templates</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="customer-rating">
                                <li class="clearfix">
                                    ...
                                    <div class="customer-review">
                                        ...
                                        <h6 class="by">By, <a href="#">Hayya</a></h6>
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="customer-review">
                                        ...
                                        <h6 class="by">By, <a href="#">Santi</a></h6>
